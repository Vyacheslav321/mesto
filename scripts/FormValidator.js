export class FormValidator {
  constructor(settings, formElement) {
    ...
    this._inputList = Array.from(this._formElement.querySelectorAll(this._settings.inputSelector));  //селектор инпута
    this._buttonElement = this._formElement.querySelector(this._settings.submitButtonSelector);  //селектор кнопки
  }
