...
const MiniCssExtractPlugin = require('mini-css-extract-plugin'); // подключили плагин mini-css-extract-plugin
...
module.exports = {
    ...
    devServer: {
      ...
      plugins: [
        ...
        new CleanWebpackPlugin(), // использовали плагин CleanWebpack
